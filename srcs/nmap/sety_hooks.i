...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "nmap/sety_hooks.c" 2
# 13 "nmap/sety_hooks.c"
# 1 "./nmap/nmap_structs.h" 1
# 17 "./nmap/nmap_structs.h"
...
# 14 "nmap/sety_hooks.c" 2


# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netdb.h" 1 3 4
# 86 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netdb.h" 3 4
...
# 87 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netdb.h" 2 3 4
...
int set_sockaddr(t_nmap_setting *root, t_nmap_link *link)
{
 ...
 {
  __builtin___memset_chk (&hints, 0, sizeof(hints), __builtin_object_size (&hints, 0));
  hints.ai_family = 0;
  hints.ai_flags = 0;
  r = getaddrinfo("localhost", ((void *)0), &hints, &res);
  if (r != 0)
  {
   r = -1;
  }
  if (r == 0)
  {
   __builtin___memcpy_chk (&link->sock, res->ai_addr, sizeof(struct sockaddr_storage), __builtin_object_size (&link->sock, 0));
   freeaddrinfo(res);
  }
 }
 fprintf(__stderrp, "%s:%d r=%d\n", __func__, 52, r);
 return (r);
}
