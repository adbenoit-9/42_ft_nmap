...
# 1 "./nmap/hooks.h" 1
# 16 "./nmap/hooks.h"
# 1 "./nmap/test_hooks.h" 1
# 19 "./nmap/test_hooks.h"
...
# 17 "./nmap/hooks.h" 2
# 1 "./nmap/mapy_hooks.h" 1
# 19 "./nmap/mapy_hooks.h"
...
int main(int ac, char **av)
{
 ...
 if (r == 0)
 {
  ...
  fprintf(__stderrp, "%s:%d configsize=%lx\n", __func__, 52, sizeof(t_root));
  fprintf(__stderrp, "%s:%d bufferptr=%p\n", __func__, 53, buf);
  fprintf(__stderrp, "%s:%d mapptr=%p\n", __func__, 54, &buf[sizeof(t_root)]);
  fprintf(__stderrp, "%s:%d limit_buffer=%p\n", __func__, 55, &buf[((256 * 250) + 23726232)]);
  root = (t_root*)buf;
