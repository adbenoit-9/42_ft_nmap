# 1 "buildy/buildy_ipv4_tcp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 370 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "buildy/buildy_ipv4_tcp.c" 2
# 13 "buildy/buildy_ipv4_tcp.c"
# 1 "./buildy/buildy.h" 1
# 16 "./buildy/buildy.h"
...
# 6 "./mapy/mapy.h" 2
# 1 "./nmap/mapy_config.h" 1
# 33 "./nmap/mapy_config.h"
# 1 "./nmap/nmap_structs.h" 1
# 18 "./nmap/nmap_structs.h"
...
# 32 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/machine/_param.h" 3 4
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/i386/_param.h" 1 3 4
# 33 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/machine/_param.h" 2 3 4
...
# 95 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/socket.h" 3 4
...
# 107 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/socket.h" 3 4
...
# 108 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/socket.h" 2 3 4
# 293 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/socket.h" 3 4
typedef __uint32_t sae_associd_t;



typedef __uint32_t sae_connid_t;
# 307 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/socket.h" 3 4
...
# 337 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/socket.h" 3 4
struct so_np_extensions {
 u_int32_t npx_flags;
 u_int32_t npx_mask;
};
# 412 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/socket.h" 3 4
struct sockaddr {
 __uint8_t sa_len;
 sa_family_t sa_family;
 char sa_data[14];
};
# 425 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/socket.h" 3 4
struct sockproto {
 __uint16_t sp_family;
 __uint16_t sp_protocol;
};
# 445 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/socket.h" 3 4
...
# 552 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/socket.h" 3 4
struct msghdr {
 void *msg_name;
...
# 600 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/socket.h" 3 4
struct cmsghdr {
 socklen_t cmsg_len;
 int cmsg_level;
 int cmsg_type;
...
# 691 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/socket.h" 3 4
struct sf_hdtr {
...
typedef int (*t_func_mapy)(uint8_t *, t_nmap_link *, t_nmap_app *, t_nmap_scan *);


typedef int (*t_func_sety_rd)(t_nmap_setting *, t_nmap_link *, t_nmap_app *, t_nmap_scan *);
typedef int (*t_func_sety_nd)(t_nmap_setting *, t_nmap_link *, t_nmap_app *);
typedef int (*t_func_sety_st)(t_nmap_setting *, t_nmap_link *);


typedef int (*t_func_exey)(t_nmap_setting *, t_exe *, t_blk *);
...
# 20 "./buildy/buildy.h" 2


# 1 "./proty/proty_ip.h" 1
# 16 "./proty/proty_ip.h"
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/ip.h" 1 3 4
# 69 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/ip.h" 3 4
...
# 375 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/in.h" 3 4
struct sockaddr_in {
 __uint8_t sin_len;
...
# 398 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/in.h" 3 4
struct ip_opts {
 struct in_addr ip_dst;
 char ip_opts[40];
};
# 507 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/in.h" 3 4
struct ip_mreq {
...
# 555 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/in.h" 3 4
...
int getsourcefilter(int, uint32_t, struct sockaddr *, socklen_t,
    uint32_t *, uint32_t *, struct sockaddr_storage *) __attribute__((availability(macosx,introduced=10.7)));
# 618 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/in.h" 3 4
struct in_pktinfo {
 unsigned int ipi_ifindex;
 struct in_addr ipi_spec_dst;
 struct in_addr ipi_addr;
};
# 660 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/in.h" 3 4
...
# 541 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet6/in6.h" 3 4
struct ipv6_mreq {
...
# 642 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet6/in6.h" 3 4
struct cmsghdr;
...
# 661 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/in.h" 2 3 4
...
# 70 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/ip.h" 2 3 4
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/in_systm.h" 1 3 4
# 84 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/in_systm.h" 3 4
typedef __uint16_t n_short;
typedef __uint32_t n_long;

typedef __uint32_t n_time;
# 71 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/ip.h" 2 3 4
# 81 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/ip.h" 3 4
struct ip {
...
# 188 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/ip.h" 3 4
struct ip_timestamp {
 u_char ipt_code;
 u_char ipt_len;
 u_char ipt_ptr;
...
# 17 "./proty/proty_ip.h" 2
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/ip6.h" 1 3 4
# 105 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/ip6.h" 3 4
struct ip6_hdr {
 union {
  struct ip6_hdrctl {
...
# 156 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/ip6.h" 3 4
struct ip6_ext {
 u_int8_t ip6e_nxt;
 u_int8_t ip6e_len;
} __attribute__((__packed__));
...
# 203 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/ip6.h" 3 4
struct ip6_opt {
 u_int8_t ip6o_type;
 u_int8_t ip6o_len;
} __attribute__((__packed__));
...
# 253 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/ip6.h" 3 4
struct ip6_rthdr {
 u_int8_t ip6r_nxt;
 u_int8_t ip6r_len;
 u_int8_t ip6r_type;
...
# 18 "./proty/proty_ip.h" 2
# 23 "./buildy/buildy.h" 2
# 1 "./proty/proty_tcp.h" 1
# 16 "./proty/proty_tcp.h"
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/tcp.h" 1 3 4
# 74 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/tcp.h" 3 4
typedef __uint32_t tcp_seq;
typedef __uint32_t tcp_cc;
# 84 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/tcp.h" 3 4
struct tcphdr {
...
# 109 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/tcp.h" 3 4
 unsigned short th_win;
 unsigned short th_sum;
 unsigned short th_urp;
};
# 235 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/tcp.h" 3 4
...
# 17 "./proty/proty_tcp.h" 2
# 47 "./proty/proty_tcp.h"
static const uint8_t syn_mss[4] = {0x02, 0x04, 0x05, 0xb4};
# 24 "./buildy/buildy.h" 2
# 1 "./proty/proty_udp.h" 1
# 16 "./proty/proty_udp.h"
# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/udp.h" 1 3 4
# 73 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/netinet/udp.h" 3 4
struct udphdr {
 u_short uh_sport;
 u_short uh_dport;
 u_short uh_ulen;
...
# 17 "./proty/proty_udp.h" 2
# 25 "./buildy/buildy.h" 2
# 1 "./buildy/buildy_utils.h" 1
# 18 "./buildy/buildy_utils.h"
...
# 26 "./buildy/buildy.h" 2
# 14 "buildy/buildy_ipv4_tcp.c" 2


# 1 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/arpa/inet.h" 1 3 4
# 75 "/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/arpa/inet.h" 3 4
...
# 17 "buildy/buildy_ipv4_tcp.c" 2
# 28 "buildy/buildy_ipv4_tcp.c"
int build_ipv4_tcp(uint8_t *buf, void *conf_st, void *conf_nd, void *conf_exec)
{
 ...
 else
 {
  ...
  __builtin___memset_chk (buf, 0, 256, __builtin_object_size (buf, 0));
  ...
  if (r == 0)
  {
   ...
   uint32_t dip;
   inet_pton(2, "127.0.0.1", &dip);
   do {((struct iphdr*)buf)->daddr = (uint32_t)dip;} while (0);
   do {((struct iphdr*)buf)->saddr = (uint32_t)dip;} while (0);

   do {((struct iphdr*)buf)->version = (uint8_t)0x04 & (uint8_t)0x0F;} while (0);
   do {((struct iphdr*)buf)->ihl = (uint8_t)0x05 & (uint8_t)0x0F;} while (0);
   do {((struct iphdr*)buf)->tos = (uint8_t)0x00;} while (0);
   do {((struct iphdr*)buf)->protocol = (uint8_t)0x06;} while (0);
   do {((struct iphdr*)buf)->frag_off = (uint16_t)0x0000;} while (0);
   do {((struct iphdr*)buf)->id = (uint16_t)(uint16_t)(*(&random[0]));} while (0);
   do {((struct iphdr*)buf)->ttl = (uint8_t)(uint8_t)(*(&random[2]));} while (0);
   do {((struct tcphdr*)&buf[sizeof(struct iphdr)])->th_seq = (uint32_t)(uint32_t)(*(&random[3]));} while (0);
   do {((struct tcphdr*)&buf[sizeof(struct iphdr)])->th_sport = (uint16_t)(uint16_t)(*(&random[7]));} while (0);
   do {((struct tcphdr*)&buf[sizeof(struct iphdr)])->th_win = (uint16_t)0x0004;} while (0);
   do {((struct tcphdr*)&buf[sizeof(struct iphdr)])->th_urp = (uint16_t)0x0000;} while (0);
   length = sizeof(struct iphdr) + sizeof(struct tcphdr);
   tcpoff = 5;

   if (((t_nmap_scan*)conf_exec)->tcpflag == 0x02)
   {
       length += 4;
    tcpoff++;
       do {if (syn_mss != 0) {__builtin___memcpy_chk (&((uint8_t*)&buf[sizeof(struct iphdr)])[sizeof(struct tcphdr)], syn_mss, 4, __builtin_object_size (&((uint8_t*)&buf[sizeof(struct iphdr)])[sizeof(struct tcphdr)], 0));}} while (0);
   }
   do {((struct tcphdr*)&buf[sizeof(struct iphdr)])->th_flags = (uint8_t)((t_nmap_scan*)conf_exec)->tcpflag;} while (0);
   do {((struct tcphdr*)&buf[sizeof(struct iphdr)])->th_dport = (uint16_t)__builtin_bswap16(((t_nmap_app*)conf_nd)->port);} while (0);
   do {((struct tcphdr*)&buf[sizeof(struct iphdr)])->th_off = (uint8_t)tcpoff & (uint8_t)0x0F;} while (0);
   do {((struct iphdr*)buf)->tot_len = (uint16_t)((__uint16_t)(__builtin_constant_p(length) ? ((__uint16_t)((((__uint16_t)(length) & 0xff00U) >> 8) | (((__uint16_t)(length) & 0x00ffU) << 8))) : _OSSwapInt16(length)));} while (0);
   do {((struct iphdr*)buf)->check = (uint16_t)ipv4_checksum((uint16_t*)buf, sizeof(struct iphdr));} while (0);

   do {((struct tcphdr*)&buf[sizeof(struct iphdr)])->th_sum = (uint16_t)tcp_ipv4_checksum(buf, length - sizeof(struct iphdr));} while (0);
