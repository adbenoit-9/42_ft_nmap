...
package x86_64_linux_gnu_bits_pthreadtypes_h is
   ...
   subtype anon965_uu_size_array is Interfaces.C.char_array (0 .. 55);
   type pthread_attr_t (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_size : aliased anon965_uu_size_array;  -- /usr/include/x86_64-linux-gnu/bits/pthreadtypes.h:58
         when others =>
